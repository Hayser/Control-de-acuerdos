...
if(isset($_POST['asiganarColaborador'])) {
...
$row = $obj->Single_Result();
?>
                      <div class="card-header">Puede escoger entre 1 o varios colaboradores </div>
                      <div class="card-body card-block">
                        <form action="" method="post" class="">
                            ...
                            <div class="card-body">
                                  ...
                                  <select  name="education[]" data-placeholder="Escoga a los colaboradores" multiple class="standardSelect">
                                  <?php
                                                    $obj->Normal_Query("SELECT *
                                                                        FROM users 
                                                                        WHERE users.rolUsuario like '%" . $user_rol . "%'");
      ...
      <div class="card">
        ...
        <div class="card-body">
                                       ...
                                       <select  name="est" data-placeholder="Seleccione un estado para el acuerdo" multiple class="standardSelect">
                                                        ...
                                                        <option value="Asignado a colaborador">Asignado a colaborador</option>
