                        ...
                        <div class="card-group">
                            ...
                            <div class="card col-md-6 no-padding ">
                                <div class="card-body">
                                    ...
                                    <div class="h4 mb-0">
                                    <?php 
                                    $obj->Normal_Query("SELECT * FROM `notificaciones` WHERE `estado` = 'leido' and (`estado_jefe` = 'Finalizado' or `estado_jefe` = 'Asignado a colaborador' or `estado_jefe` = 'Incompleto') and `fecha_hora` BETWEEN date_sub(now(), interval 1 day)  AND NOW() ORDER BY `fecha_hora` DESC");
                                    $row = $obj->Count_Rows();
                                    ?>
                                        <span class="count"><?php echo $row; ?></span>
                                    </div>
                            ...
                            <div class="card col-md-6 no-padding ">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $obj->Normal_Query("SELECT estado_alcaldia FROM acuerdos WHERE estado_alcaldia LIKE 'Finalizado'");
                                    $tot = $obj->Count_Rows();
                                    $obj->Normal_Query("SELECT * FROM acuerdos");
                                    $row = $obj->Count_Rows();
                                    $total = 0;
