...
if (isset($_GET['notificacion'])) {
    ...
    if ($obj->Normal_Query("UPDATE `notificaciones` SET estado = 'leido' WHERE num_acuerdo = ?", [$num])){
        ...
        header("location:editarAcuerdolCol.php?id=$id");
    }
}    
?>
    ...
    <div class="col-sm-7">
        ...
        <div class="header-left">
            ...
            <div class="form-inline">
                ...
                <?php
                $obj->Normal_Query("SELECT * FROM `acuerdos` WHERE `colaboradores` like '%" . $user_name . "%'");
                    $row = $obj->Count_Rows();
                    if ($row > 0) {
                        $obj->Normal_Query("SELECT * FROM `notificaciones` WHERE `estado` = 'no_leido' and (`estado_jefe` = 'Asignado a colaborador') ORDER BY `fecha_hora` DESC");
                        $row = $obj->Count_Rows();
                    }
                ?>
                ...
                <div class="dropdown for-notification">
                    ...
                    <div class="dropdown-menu" aria-labelledby="notification" style="border-style: groove;">
                        ...
                        ?>
                        <a class="dropdown-item media bg-flat-color-20" href="principalColaborador.php?notificacion=<?php echo $row->num_acuerdo ?>">
    ...
    <div class="col-sm-5">
        <div class="user-area dropdown float-right">
            ...
            <div class="user-menu dropdown-menu">
                    <a class="nav-link" href="perfilColaborador.php"><i class="menu-icon fa fa-user"></i> Mi Perfil</a>
