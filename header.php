<header id="header" class="header">
    ...
    if (isset($_POST['buscar'])) {
        header("location: ../MuniV5.1/editarAcuerdo.php");
        //exit();
    }
    ...
    if (isset($_GET['notificacion'])) {
        ...
        if ($obj->Normal_Query("UPDATE `notificaciones` SET estado = 'leido' WHERE num_acuerdo = ?", [$num])){
            ...
            header("location:editarFecha.php?id=$id");
        }
    }
    ?>
            ...
            <div class="header-left">
                ...
                <div class="form-inline">
                    <form class="search-form">
                        ...
                        <button class="search-close" name="buscar" type="submit"><i class="fa fa-close"></i></button>
                    </form>
                </div>

                <?php
                $obj->Normal_Query("SELECT * FROM `notificaciones` WHERE `estado` = 'no_leido' and (`estado_jefe` = 'Finalizado' or `estado_jefe` = 'Asignado a colaborador' or `estado_jefe` = 'Incompleto') ORDER BY `fecha_hora` DESC");
                $row = $obj->Count_Rows();
                ?>
                ...
                <div class="dropdown for-notification">
                    ...
                    <div class="dropdown-menu" aria-labelledby="notification" style="border-style: groove;">
                        ...
                        ?>
                        <a class="dropdown-item media bg-flat-color-20" href="principal.php?notificacion=<?php echo $row->num_acuerdo ?>">
                    ...
                    <div class="dropdown-menu" aria-labelledby="notification" style="border-style: groove;">
                        <?php
                        $obj->Normal_Query("SELECT * FROM `notificaciones` WHERE `estado` = 'leido' and (`estado_jefe` = 'Finalizado' or `estado_jefe` = 'Asignado a colaborador' or `estado_jefe` = 'Incompleto') and `fecha_hora` BETWEEN date_sub(now(), interval 1 week)  AND NOW() ORDER BY `fecha_hora` DESC");
                        $message_row = $obj->fetch_all();
                        foreach ($message_row as $row) :
                        ?>
                        <a class="dropdown-item media bg-flat-color-20" href="principal.php?notificacion=<?php echo $row->num_acuerdo ?>">
        ...
        <div class="col-sm-5">
            <div class="user-area dropdown float-right">
                ...
                <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="perfil.php"><i class="menu-icon fa fa-user"></i> Mi Perfil</a>
